...
namespace HOK.NasuniAuditEventAPI
{
    public class Startup
    {
        ...
        //    nasuniEventStreamReader = new DAL.NasuniEventReader(ilogger, GlobalSettings.Settings.NasuniLogFolderToTail, GlobalSettings.Settings.MaxItemsToReturn, GlobalSettings.Settings.MinimumAgeOfEventInMinutes);
