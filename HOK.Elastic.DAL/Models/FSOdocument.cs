...
namespace HOK.Elastic.DAL.Models
{
    ...
    {
        private static readonly HashSet<string> _supportedExtensions = new HashSet<string> { ".pdf", ".doc", ".docx", ".xls", ".xlsx",".xlk", ".csv", ".ppt", ".pptx", ".wpd",".wbk", ".rtf", ".txt" };//excluded .log file per teams converstation 2021-02-08
